    ...
    if (|xfer_cycles) begin
      ...
      case (state)
        ...
        S7_WAIT_FOR_XFER_DONE: begin
          if (PSRAM_SPIFLASH) begin
            rdata_next = {spi_buf[7:0], spi_buf[15:8], spi_buf[23:16], spi_buf[31:24]};//spi_buf;
          end else begin
...
module align_wdata (
  ...
  always @(*) begin
    ...
    case (wstrb)
      ...
      4'b1111: begin
        byte_offset = 0;
        wr_buffer[31:0] = {wdata[7:0], wdata[15:8], wdata[23:16], wdata[31:24]};
        wr_cycles = 32;
      end
      default: begin
        byte_offset = 0;
        wr_buffer   = {wdata[7:0], wdata[15:8], wdata[23:16], wdata[31:24]};
        wr_cycles   = 32;
      end
    endcase
  end
