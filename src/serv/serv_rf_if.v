...
module serv_rf_if
  ...
  (//RF Interface
    ...
    */
    ...
    if (EMBEDDED==1) begin: gen_rv32e_wreg
      assign o_wreg0 = i_trap ? {5'b10011} : {i_rd_waddr} ;
      assign o_wreg1 = i_trap ? {5'b10010} : {3'b100,i_csr_addr} ;
    end else begin: gen_rv32i_wreg
  ...
  //assign o_wreg1 = EMBEDDED ? (i_trap ? {6'b010010} : {4'b0100,i_csr_addr}) : (i_trap ? {6'b100010} : {4'b1000,i_csr_addr});
   ...
   if (EMBEDDED==1) begin: gen_rv32e_rreg0
    assign o_rreg0 =  i_rs1_raddr ;
   end else begin : gen_rv32i_rreg0
   ...
   if (EMBEDDED==1) begin: gen_rv32e_rreg1
    assign o_rreg1 = ({~sel_rs2,
           i_rs2_raddr[3:2] & {2{sel_rs2}},
           {1'b0,i_trap} | {i_mret,1'b0} | ({2{i_csr_en}} & i_csr_addr) | ({2{sel_rs2}} & i_rs2_raddr[1:0])}) ;
   end else begin: gen_rv32i_rreg1
    assign o_rreg1 = ({~sel_rs2,
